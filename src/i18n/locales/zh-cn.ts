...
export const zhCn = {
	...
	ui: {
		...
		mode_faithful: "本地保真",
		mode_themed: "主题站点",
		mode_faithful_hint: "本地保真：保留笔记库的链接与结构，适合公开分享。",
		mode_themed_hint: "主题站点：使用 Foundry 主题生成站点；不含本地主题与社区插件效果。",
		badge_note: "单篇",
		badge_wiki: "Wiki",
		...
		account_guest_title: "访客模式 · 将自动分配 KEY",
		account_guest_hint: "首次发布需完成人机验证。",
		account_continue_auth: "继续认证",
		account_go_auth: "前往 mdfriday.com 认证 ↗",
		account_learn_quota: "了解额度",
		account_daily_title: "今日免费额度",
		account_daily_hint: "次日 UTC 00:00 清空（北京时间 08:00）。",
		account_google_keep: "用 Google 登录，保留 30 天 · 存储升至 50M",
		account_upgrade_pro: "升级 Pro",
		account_free_badge: "已登录",
		account_upgrade_pro_detail: "升级 Pro · $5/月 · 无限站点 · 1G",
		account_manage: "管理账号",
		account_pro_storage: "无限站点",
		...
		account_google_login: "Google 登录",
		revoke_share: "撤销分享",

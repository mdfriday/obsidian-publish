...
export const zhCn = {
	...
	ui: {
		...
		copy_url: "拷贝地址",
		copy: "拷贝",
		realtime_publishing: "自动发布中…",
		realtime_publish: "自动发布",
		realtime_publish_hint: "笔记有改动时，自动重新发布到线上",
		auto_publish: "自动发布",
		stop_publish: "停止",
		stop: "停止",
		settings: "设置",
		...
		publish_prepare_title: "准备发布",
		publish_prepare_body: "将打开一次在线验证（约 10 秒），无需注册账号。",
		publish_prepare_continue: "继续",
		publish_prepare_waiting: "请在浏览器中完成验证…",

		growth_title_success: "站点已上线",
		growth_guest_keep: "登录以保留站点",
		growth_guest_lead: "免费账号即可获得：",
		growth_guest_benefit_keep: "保留当前站点（访客链接会在 UTC 午夜清空）",
		growth_guest_benefit_same_url: "认领当前链接，无需重新发布",
		growth_guest_benefit_projects: "同一账号管理多个站点",
		growth_guest_expiry: "访客站点将在 UTC 午夜清除",
		growth_upgrade_title: "升级到 Personal",
		growth_upgrade_lead: "Personal 可解锁：",
		growth_upgrade_benefit_domain: "绑定自己的自定义域名",
		growth_upgrade_benefit_history: "发布历史与一键回滚",
		growth_upgrade_benefit_storage: "更大存储空间与永久托管",
		growth_upgrade_body: "Personal 可永久保留站点、自定义域名与发布回滚。",
		growth_upgrade_cta: "升级…",
		growth_whats_next: "接下来可以",
		growth_change_theme: "更换主题",
		growth_custom_domain: "使用自定义域名",
		growth_analytics: "添加统计",
		growth_comments: "添加评论",
		growth_studio: "用 Studio 深度定制",
		publish_again: "再次发布",
		publish_site: "发布站点",
		preview_action: "预览",
		retry_publish: "重试发布",
		...
		theme_empty: "暂无可用主题",
		banner_guest: "Guest · 5 MB · 下一个 UTC 00:00 清空 · ",
		banner_free: "Free · 50 MB · 每月 1 日清空 · 升级 Personal 解锁域名 / 永久保留 / 历史 · ",
		...
		password_personal_only: "Personal 计划可用 · 升级后解锁访问密码",
		domain_personal_only: "Guest / Free 锁定 · 升级 Personal 可配置自定义域名",
		domain_unbound: "未绑定",
		domain_bound: "已绑定",
		domain_helper: "绑定后通过你的域名访问已发布站点",
		verify_and_publish: "验证并发布",
		verify_title: "需要人机验证",
		verify_desc: "Guest 首次发布需在 mdfriday.com 完成验证，确认你是真人。",
		verify_step1: "点击下方前往 mdfriday.com",
		verify_step2: "完成人机验证（Turnstile）",
		verify_step3: "回到 Obsidian，继续发布",
		verify_go: "前往 mdfriday.com 验证",
		building_title: "正在构建…",
		...
		err_quota_projects_guest:
			"Guest 只能发布 1 个站点，已达上限。免费注册可扩到 3 个站点，并保留现有链接。",
		err_quota_projects_free:
			"Free 最多 3 个站点，已达上限。升级 Personal 可无限站点、永久保留与自定义域名。",
		err_quota_storage_guest:
			"Guest 存储（5 MB）已满。免费注册可获得 50 MB，或删减文件后重试。",
		err_quota_storage_free:
			"Free 存储（50 MB）已满。升级 Personal 可获得 1 GB，或删减文件后重试。",
		err_quota_storage_personal: "存储配额已满。请腾出空间后重试，若异常请联系支持。",
		claim_refresh_ok: "已登录 — 当前套餐：{{plan}}",
		...
		theme_all: "在官网查看全部主题",
		panel_slogan: "专注创作，一键发布，本地优先尽在掌控",
		account_guest_unverified_title: "Guest · 访客试用",
		account_guest_unverified_sub: "首次发布需完成认证",
		account_go_verify: "前往认证",
		account_guest_ready_title: "Guest · 今日可发布",
		account_guest_ready_sub: "5 MB · 内容将在下一 UTC 00:00 清空（北京时间 08:00）",
		account_claim_free: "领取 Free 保留站点",
		account_upgrade_personal: "升级 Personal",
		account_free_title: "Free · {{email}}",
		account_free_title_no_email: "Free",
		account_free_sub: "50 MB · 站点将在每月 1 日清空",
		account_personal_title: "Personal · {{email}}",
		account_personal_title_no_email: "Personal",
		account_personal_sub: "1 GB · 永久保留 · 可绑 3 个自定义域名",
		account_manage: "管理账号",
		...
		account_continue_auth: "继续认证",
		account_go_auth: "前往 mdfriday.com 认证 ↗",
		account_learn_quota: "了解额度",
		account_daily_title: "Guest · 今日可发布",
		account_daily_hint: "5 MB · 内容将在下一 UTC 00:00 清空（北京时间 08:00）",
		account_google_keep: "领取 Free 保留站点",
		account_upgrade_pro: "升级 Personal",
		account_upgrade_personal_detail: "升级 Personal · 无限站点 · 自定义域名",
		account_free_badge: "免费",
		account_google_free_title: "Free",
		account_monthly_recycle: "站点将在每月 1 日清空",
		account_upgrade_pro_detail: "升级 Personal · $5/月",
		account_pro_storage: "永久保留",
		account_google_login: "领取 Free",
		more_settings: "更多",
		theme_catalog_hint: "在线浏览主题：",
		theme_hidden_placeholder: "主题（不显示）",
		mode_themed_fixed: "主题发布（固定）",
		custom_domain: "自定义域名",
		domain_not_bound: "未配置",
		...
		domain_unbind_confirm:
			"解除绑定 {{host}}？站点将改回分享链接。证书会保留，之后可快速重新绑定到其他项目。",
		domain_unbind_done: "已解除绑定",
		domain_conflict_other_project:
			"该域名已绑定到站点「{{title}}」。请先在那个站点解除绑定。",
		domain_bound_label: "已绑定",
		domain_copied: "已复制",
		domain_input_label: "域名",
		output_empty_both: "暂无输出记录",
		history: "历史",
		publish_auth_tip: "请点右下角前往 mdfriday.com 认证",
		site_password_confirm_placeholder: "确认密码",
		password_set: "已设置",
		...
		// Preview section
		preview: "本地预览",
		preview_building: "正在准备本地预览…",
		preview_preparing: "准备中…",
		preview_success: "本地预览已就绪",
		preview_failed: "无法打开本地预览",
		preview_hint: "先在浏览器里看看效果，再发布到网上。",
		generate_preview: "打开本地预览",
		regenerate_preview: "刷新本地预览",
		preview_link: "本地预览地址",
		preview_ready: "可查看",
		preview_off: "未开启",
		export_site: "导出站点",

...
export const zhCn = {
	...
	ui: {
		...
		password_helper: "留空则公开访问；访客需输入密码才能查看",
		password_personal_only: "Personal 计划可用访问密码",
		domain_personal_only: "Personal 计划可用自定义域名",
		...
		mode_faithful: "原样发布",
		mode_themed: "主题发布",
		mode_faithful_hint: "与 Obsidian 里看到的一致（保留当前主题、样式与本页插件效果）",
		mode_themed_hint: "用站点主题重新排版；不保留本地主题与社区插件样式",
		mode_folder_hint: "文件夹将发布为 Wiki 站点，需选择主题",
		badge_note: "单篇",
		badge_wiki: "Wiki",

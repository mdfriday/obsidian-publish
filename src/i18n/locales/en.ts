...
export const en = {
	...
	ui: {
		...
		account_personal_sub: "1 GB · permanent · 3 custom domains",
		...
		domain_unbind_confirm:
			"Unbind {{host}}? This site will fall back to the share URL. The certificate is kept so you can quickly rebind to another project later.",
		domain_unbind_done: "Domain unbound",
		domain_conflict_other_project:
			"This domain is bound to “{{title}}”. Unbind it there first.",

...
export const en = {
	...
	ui: {
		...
		password_helper: "Leave empty for public access",
		password_personal_only: "Access password requires Personal",
		domain_personal_only: "Custom domain requires Personal",
		...
		mode_faithful_hint:
			"Matches what you see in Obsidian (keeps current theme, styles, and this note’s plugin effects).",
		mode_themed_hint:
			"Restyled with a site theme; local themes and community plugin styles are not kept.",
		mode_folder_hint: "Folders publish as a Wiki site — pick a theme.",
		badge_note: "Note",
		badge_wiki: "Wiki",

...
export const en = {
	...
	ui: {
		...
		mode_faithful: "Local faithful",
		mode_themed: "Themed site",
		mode_faithful_hint: "Share only this note, keeping layout and effects consistent.",
		mode_themed_hint: "Build a themed multi-page site, good for wikis.",
		badge_note: "Note",
		badge_wiki: "Wiki",
		...
		mode_themed_fixed: "Themed site (fixed)",

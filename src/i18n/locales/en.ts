...
export const en = {
	...
	ui: {
		...
		plan_guest_b2: "Unlimited sites / builds / exports",
		...
		softgate_desc: "Sign up free to claim Guest sites, keep the same URL, and get 50 MB. Sites clear on the 1st each month.",

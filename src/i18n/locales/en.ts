...
export const en = {
	...
	ui: {
		...
		mode_faithful_hint: "Keeps your current Obsidian theme, styles, and page plugin effects.",
		mode_themed_hint: "Foundry themed site; local themes and community plugins are not included.",
		badge_note: "Note",
		badge_wiki: "Wiki",
		...
		account_guest_title: "Guest · KEY will be assigned",
		account_guest_hint: "First publish requires human verification.",
		...
		account_daily_title: "Today's free quota",
		account_daily_hint: "Resets at UTC 00:00 (Beijing 08:00).",
		account_google_keep: "Sign in with Google · keep 30 days · 50M",
		account_upgrade_pro: "Upgrade Pro",
		account_free_badge: "Signed in",
		account_upgrade_pro_detail: "Upgrade Pro · $5/mo · unlimited sites · 1G",
		account_manage: "Manage account",
		account_pro_storage: "Unlimited sites",
		...
		account_google_login: "Google sign-in",

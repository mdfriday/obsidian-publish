...
export interface TranslationNamespace {
	...
	ui: {
		...
		retry_publish: string;
		publish_mode: string;
		mode_faithful: string;
		mode_themed: string;
		...
		theme_all: string;
		panel_slogan: string;
		account_guest_title: string;
		account_guest_hint: string;
		account_continue_auth: string;
		account_go_auth: string;
		account_learn_quota: string;
		account_daily_title: string;
		account_daily_hint: string;
		account_google_keep: string;
		account_upgrade_pro: string;
		account_upgrade_personal: string;
		account_upgrade_personal_detail: string;
		account_free_badge: string;
		account_google_free_title: string;
		account_monthly_recycle: string;
		account_upgrade_pro_detail: string;
		account_manage: string;
		account_pro_storage: string;
		account_manage_sub: string;
		account_personal_price: string;
		account_guest_unverified_title: string;
		account_guest_unverified_sub: string;
		account_go_verify: string;
		account_guest_ready_title: string;
		account_guest_ready_sub: string;
		account_claim_free: string;
		account_free_title: string;
		account_free_title_no_email: string;
		account_free_sub: string;
		account_personal_title: string;
		account_personal_title_no_email: string;
		account_personal_sub: string;
		account_domain_personal_only: string;
		account_history_personal_only: string;
		more_settings: string;
		theme_catalog_hint: string;
		theme_hidden_placeholder: string;
		...
		domain_step1_title: string;
		domain_step1_hint: string;
		domain_step1_cta: string;
		domain_step2_title: string;
		domain_step3_title: string;
		domain_host_col: string;
		domain_type_col: string;
		domain_value_col: string;
		domain_note_col: string;
		domain_note_point: string;
		domain_note_verify: string;
		domain_note_https: string;
		domain_host_hint: string;
		domain_host_hint_advanced: string;
		domain_step2_li1: string;
		domain_step2_li2: string;
		domain_step2_li3: string;
		domain_verify_cta: string;
		domain_https_hint: string;
		domain_https_wait: string;
		domain_https_records_loading: string;
		domain_https_records_missing: string;
		domain_refresh_status: string;
		domain_wait_refresh: string;
		domain_done_hint: string;
		domain_revoke: string;
		domain_unbind_confirm: string;
		domain_unbind_done: string;
		domain_conflict_other_project: string;
		domain_bound_label: string;
		domain_copied: string;
		domain_input_label: string;
		...
		output_online: string;
		output_preview: string;
		output_empty_online: string;
		output_empty_preview: string;
		account_google_login: string;
		revoke_share: string;
		revoke_share_confirm: string;
		revoke_share_done: string;
